   ...
   $(function(){
		...
		$("#favorite").click(function(){
				$.ajax({
					...
					error:function(err){
						//alert(err+'=>error 에러발생');
						alert('이미 즐겨찾기 추가된 친구입니다!');
					}
				});//ajax끝			
		})//click끝
	 })
    ...
    <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        <div class="container">
         ...
         <button class="btn btn-nav" type="button">${sessionScope.nickname}님 환영합니다</button>
            <a href="logout.do"><button class="btn btn-nav" type="button">Logout</button></a>
            </form>
         </div>
            <!-- /.navbar-collapse -->
        </div>
    ...
    <div class="container">
       ...
       <div class="row">
         <div class="col-lg-12">
            ...
            <li><a href="goFriendListPage.do?owner=<%=request.getAttribute("owner")%>">Favorite</a></li>
            </ul>
         </div>
      </div>
      ...
      <div class="row">
         ...
         <div class="col-lg-2" align="center"
            style="position: fixed; right: 60px; bottom:80px;">
