...
public class BoardController {
	...
	@RequestMapping(value = "/loadGetScrap.do", method = RequestMethod.POST)
	public ModelAndView loadGetScrap(HttpServletRequest request, HttpServletResponse response, HttpSession session){
		System.out.println("loadGetScrap::ENTER");
		String userNo = String.valueOf(request.getParameter("userNo"));
		int curPage = Integer.parseInt(request.getParameter("curPage"));
		List<BoardVo> boardVoList = boardService.loadGetScrap(userNo);
		ArrayList<BoardVo> resultBoardVoList = new ArrayList<BoardVo>();
		...
		ModelAndView mv = new ModelAndView("jsonView");
		mv.addObject("resultBoardVoList",resultBoardVoList);
		System.out.println("loadGetScrap::boardVoList.size() = "+boardVoList.size());
		System.out.println("loadGetScrap::curPage = "+curPage);
		System.out.println("loadGetScrap::END");
		return mv;
	}
	...
	@RequestMapping(value = "/getNumOfGetScrap.do", method = RequestMethod.POST)
	public @ResponseBody String getNumOfGetScrap(String userNo) {                 
		 System.out.println("getNumOfGetScrap::");
		 return String.valueOf(boardService.getNumOfGetScrap(userNo));
	  }
